...
- `scripts/verify-default-poster.mjs` bundles the actual domain, poster, export and global stylesheet modules. Seven browser layouts produced real PNGs; each was checked for 1080×1440 dimensions, 1080×608 contain region, title/footer separation, two-line nickname maximum and complete, bounded links. Original PNG visually inspected against approved v5/adaptation.
