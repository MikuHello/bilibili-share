...
for (const suite of ["b3-poster", "text-recovery", "text-isolation", "share-targets", "update-races", "marker-smoothness", "independent-exports", "final-panel", "appearance", "lifecycle", "update-performance"]) {
